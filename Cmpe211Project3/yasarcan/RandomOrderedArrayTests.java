...
public class RandomOrderedArrayTests {
	...
	@Test
	public void MergeSortRandomOrdered() {
		Helper h1 = new Helper();
	...
	@Test
	public void HeapSortRandomOrdered() {
		Helper h1 = new Helper();
	...
	public void InsertionSortTime(){
		...
		System.out.println();
		iS1.printTimeForRandomOrdered(100);
		iS1.printTimeForRandomOrdered(1000);
		iS1.printTimeForRandomOrdered(10000);
		iS1.printTimeForRandomOrdered(100000);
